...
Puntos fuertes
- Desarrollo frontend moderno: React, HTML y CSS
- Buenas prácticas: testing, control de versiones, code reviews y documentación.
- Interés y fundamentos en Data Science: limpieza de datos, visualización y modelos básicos.
- Despliegue y CI/CD: experiencia con Vercel (deploys automáticos) y pipelines ligeros.
- Desarrollo Backend 
- Desarrollo y habilidad destacada con Bases de Datos (PostgreSQL y Oracle)
